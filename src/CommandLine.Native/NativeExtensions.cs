// -----------------------------------------------------------------------
// <copyright file="NativeExtensions.cs" company="Altavec">
...
internal static class NativeExtensions
{
    ...
    private static class NativeAction
    {
        ...
        {
            if (Altavec.Runtime.InteropServices.RuntimeEnvironment.GetRuntimeNativeDirectory() is { } nativeDirectory)
            {
                Altavec.Runtime.InteropServices.RuntimeEnvironment.AddDirectoryToPath(nativeDirectory);
            }

            Altavec.Runtime.Resolve.RuntimeAssemblies();
        }

        private static void AfterInvoke() => Altavec.Runtime.Resolve.Remove();
